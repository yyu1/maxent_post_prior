...
min_pdf_points = 5000
;
train_file = '~/global_250m/samples/hlorey_train_v3/sea/train_hlorey_sea_v3_con_cl40_wbin.csv'
in_dir = '/nobackup/yyu1/global_250m_output/sea/cl_con_40'
out_dir = '/nobackup/yyu1/global_250m_output/sea/cl_con_40/results'
bin_file = '~/global_250m/samples/hlorey_train_v3/sea/bin_hlorey_sea_v3_con_cl40.csv'
;
;spawn, 'mkdir ' + out_dir
