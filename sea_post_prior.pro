...
train_file = '~/global_250m/hlorey_train/train_hlorey_sea_v1_misclass_wbin.csv'
in_dir = '/nobackup/yyu1/global_250m_output/sea/cl_miss'
out_dir = '/nobackup/yyu1/global_250m_output/sea/cl_miss/results'
bin_file = '~/global_250m/hlorey_train/bin_hlorey_sea_v1_misclass.csv'
...
train_file = '~/global_250m/hlorey_train/train_hlorey_sea_v1_misclass_wbin.csv'
in_dir = '/nobackup/yyu1/global_250m_output/sea/cl_miss_nomodis'
out_dir = '/nobackup/yyu1/global_250m_output/sea/cl_miss_nomodis/results'
bin_file = '~/global_250m/hlorey_train/bin_hlorey_sea_v1_misclass.csv'
...
train_file = '~/global_250m/hlorey_train/train_hlorey_sea_v1_cl40_wbin.csv'
in_dir = '/nobackup/yyu1/global_250m_output/sea/cl_40'
out_dir = '/nobackup/yyu1/global_250m_output/sea/cl_40/results'
bin_file = '~/global_250m/hlorey_train/bin_hlorey_sea_v1_cl40.csv'
