...
PRO maxent_post_vectorized_prior_n1, xdim, ydim, in_dir, out_dir, def_bin_file, local_pdf
	...
	for j=0UL, n_segments-1 do begin
		...
		combine_prob_n1, maxent_prob, prior_prob, mBioVals, out_expect_val, out_error_val
